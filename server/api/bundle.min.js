...
AV.Cloud.define("getQiniuJSON",r=>getQiniuJSON(r));
...
AV.Cloud.define("getShimoTokenRaw",r=>getShimoTokenRaw(r));
...
AV.Cloud.define("postFormShimo",r=>postFormShimo(r));
...
AV.Cloud.define("save2LeanCloud",r=>save2LeanCloud(r));
function test(request) {
    return "success!!!"
};

AV.Cloud.define("test",r=>test(r));
...
AV.Cloud.define("updateShimo",r=>updateShimo(r));