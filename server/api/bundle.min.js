const AV = require('leanengine');const requestJS = require('request');
var AV_Cloud_Define=AV.Cloud.define
...
AV_Cloud_Define("getQiniuJSON",r=>getQiniuJSON(r));
...
AV_Cloud_Define("getShimoTokenRaw",r=>getShimoTokenRaw(r));
...
AV_Cloud_Define("postFormShimo",r=>postFormShimo(r));
...
AV_Cloud_Define("save2LeanCloud",r=>save2LeanCloud(r));
function test(request) {
    return "success!!!"
};

AV_Cloud_Define("test",r=>test(r));
...
AV_Cloud_Define("updateShimo",r=>updateShimo(r));