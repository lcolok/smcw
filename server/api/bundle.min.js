...
AV.Cloud.define("postFormShimo", async function (request) {
            return await postFormShimo(request);
        });
...
AV.Cloud.define("save2LeanCloud", async function (request) {
            return await save2LeanCloud(request);
        });
function test(request) {
    return "success!!!"
};

AV.Cloud.define("test", async function (request) {
...
AV.Cloud.define("updateShimo", async function (request) {
            return await updateShimo(request);
        });