module.exports = () => {
    ...
    var PORT = parseInt(process.env.LEANCLOUD_APP_ENV == "development" ? require(path.resolve('api/config/api.config.js')).dev.port : (process.env.LEANCLOUD_APP_PORT || process.env.PORT || 3000));
